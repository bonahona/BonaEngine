...
private:
	...
	void createGraphicsPipeline() {
		...
		colorBlendAttachment.colorWriteMask = VK_COLOR_COMPONENT_R_BIT | VK_COLOR_COMPONENT_G_BIT | VK_COLOR_COMPONENT_A_BIT | VK_COLOR_COMPONENT_A_BIT;
	...
	void createVertexBuffer() {
		...
		allocateInfo.memoryTypeIndex = findMemoryType(memoryRequirement.memoryTypeBits, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT);
		
		if (vkAllocateMemory(device, &allocateInfo, nullptr, vertexBufferMemory.replace()) != VK_SUCCESS) {
